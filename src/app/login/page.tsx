...
export default function LoginPage() {
  ...
  return (
    <div 
      ref={containerRef}
      className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-linear-to-br from-slate-50 via-blue-50/30 to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
    >
      {/* Enhanced Animated Background */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        {/* Animated Gradient Orbs */}
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-linear-to-br from-blue-400/20 to-cyan-400/15 rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '8s' }} />
        <div className="absolute top-1/4 -right-20 w-72 h-72 bg-linear-to-br from-purple-400/20 to-pink-400/15 rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '10s', animationDelay: '2s' }} />
        <div className="absolute -bottom-20 left-1/4 w-64 h-64 bg-linear-to-br from-indigo-400/20 to-blue-400/15 rounded-full blur-3xl animate-pulse" 
        ...
        <div 
          className="absolute w-64 h-64 bg-linear-to-r from-blue-500/8 via-purple-500/8 to-pink-500/8 rounded-full blur-3xl transition-all duration-700 ease-out pointer-events-none"
          style={{
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="relative group">
                  {/* Glow effect */}
                  <div className="absolute -inset-1 bg-linear-to-r from-blue-500 via-purple-600 to-pink-600 rounded-xl blur-md opacity-40 group-hover:opacity-60 transition-opacity duration-300 animate-pulse" />
                  {/* Icon container */}
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-blue-500 via-indigo-500 to-pink-500 shadow-xl transform group-hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  <h1 className="text-2xl font-bold tracking-tight bg-linear-to-r from-blue-600 via-indigo-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                    PlanEdu
                  </h1>
              ...
              <div className="space-y-3">
                <h2 className="text-3xl lg:text-4xl font-bold tracking-tight leading-tight">
                  ...
                  <span className="relative inline-block">
                    ...
                    <div className="absolute -bottom-1 left-0 right-0 h-2 bg-linear-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-full blur-sm" />
                  </span>
                </h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex items-start gap-3">
                      <div className={cn(
                        "relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-linear-to-br shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500",
          ...
          <div className="w-full max-w-sm mx-auto lg:mx-0 animate-fade-in">
            <Card className="relative border-slate-200/60 dark:border-slate-800/60 shadow-2xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-purple-500/0 to-pink-500/0 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-500 -z-10 blur-xl" />
              
              <CardContent className="p-6 space-y-5">
                {/* Enhanced Header */}
                <div className="space-y-2 text-center">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br from-blue-500 via-indigo-500 to-purple-600 shadow-lg mb-1 transform hover:scale-105 transition-transform">
                    <Lock className="h-5 w-5 text-white" />
                  </div>
                  <h3 className="text-xl font-bold tracking-tight bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                    Hoş Geldiniz
                  </h3>
                  <p className="text-xs text-muted-foreground font-medium">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 rounded-lg bg-linear-to-r from-blue-500/0 via-purple-500/0 to-pink-500/0 group-focus-within:from-blue-500/15 group-focus-within:via-purple-500/15 group-focus-within:to-pink-500/15 blur-md transition-all duration-300 -z-10" />
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        disabled={isLoading}
                        className="border-2 border-slate-300 dark:border-slate-700 data-[state=checked]:bg-linear-to-br data-[state=checked]:from-blue-600 data-[state=checked]:to-purple-600 data-[state=checked]:border-transparent h-4 w-4"
                      />
                      <label
                        htmlFor="remember"
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    ...
                    disabled={isLoading}
                    className="h-auto py-2.5 flex flex-col items-center gap-1.5 border-2 hover:border-blue-500 hover:bg-linear-to-br hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-950/30 dark:hover:to-indigo-950/30 transition-all duration-300 group relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-linear-to-br from-blue-500/0 to-indigo-500/0 group-hover:from-blue-500/10 group-hover:to-indigo-500/10 transition-all duration-300" />
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                    className="h-auto py-2.5 flex flex-col items-center gap-1.5 border-2 hover:border-emerald-500 hover:bg-linear-to-br hover:from-emerald-50 hover:to-teal-50 dark:hover:from-emerald-950/30 dark:hover:to-teal-950/30 transition-all duration-300 group relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-linear-to-br from-emerald-500/0 to-teal-500/0 group-hover:from-emerald-500/10 group-hover:to-teal-500/10 transition-all duration-300" />
